...
<body class="h-screen w-screen bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
    <div class="flex items-center justify-center h-full backdrop-blur-sm bg-black/30">
        <div class="bg-white/30 backdrop-blur-lg rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
            ...
            <p class="text-white mb-6">Silakan login sebagai:</p>

            <div class="space-y-4">
                <a href="http://127.0.0.1:8000/admin/login" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition duration-200">
                    Login sebagai Admin
                </a>
                <a href="http://127.0.0.1:8000/admin/login" class="block w-full text-center bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg transition duration-200">
                    Login sebagai Kepala
                </a>
                <a href="http://127.0.0.1:8000/employee/login" class="block w-full text-center bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-4 rounded-lg transition duration-200">
